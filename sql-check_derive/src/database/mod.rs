//! Database extension trait and caching for compile-time SQL validation
...
/// Extension trait for databases to support compile-time SQL validation
...
/// Caches database connections for compile-time SQL validation
#[allow(dead_code)]
